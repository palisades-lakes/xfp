...
public final class Divide5 {
  ...
  private static final double divide3 (final BigInteger n,
    ...
    final int shift0 = 
      SIGNIFICAND_BITS + Math.min(52,hiBit(d) - hiBit(n));

    debug("hiBit(d) - hiBit(n)= " + (hiBit(d) - hiBit(n)));
    debug("shift0= " + shift0);
  ...
  public static final void main (final String[] args) {
    ...
    //    debug(nmdr6.abs().compareTo(nmdr7.abs()));
    //    debug();
