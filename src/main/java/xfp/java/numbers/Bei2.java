...
public final class Bei2 {
  ...
  // assuming m0 has no leading zero words
  public static final int compare (final int[] m0,
                                   final long m1,
                                   final int bitShift) {
...
//    Debug.println("remShift=" + remShift);
    final int hi = remShift + hiBit(m1);
    final int n1 = intShift 
      + ((64 < hi) ? 3 : ((32 < hi) ? 2 : 1));
...
//    Debug.println("n1=" + n1);
  ...
  public static final int[] subtract (final int[] m0,
    ...
    // Copy remainder of longer number
    while (bigIndex > 0) { result[--bigIndex] = m0[bigIndex]; }
