...
public final class BigFloatN 
extends Number
implements Comparable<BigFloatN> {
  ...
  //  private static final boolean isNegative (final Natural i) {
  //    return 0 > i.signum(); }

  private static final boolean isZero (final Natural i) {
    return i.equals(Natural.ZERO); }

  public final boolean isZero () { return isZero(significand()); }

  public final boolean isOne () { 
    return BigFloatN.ONE.equals(this); }

  //--------------------------------------------------------------

  public final BigFloatN negate () {
  ...
  private static final BigFloatN add (final boolean n1,
                                      final long t1,
                                      final int leftShift,
                                      final boolean n0,
                                      final Natural t0,
  ...
  private final BigFloatN add (final boolean n1,
                               final long t1,
                               final int e1) {
  ...
  public final BigFloatN add (final double z) {
  ...
  public final BigFloatN add (final BigFloatN q) {
    if (isZero()) { return q; }
  ...
  public final BigFloatN subtract (final BigFloatN q) {
  ...
  public final BigFloatN abs () {
    if (nonNegative()) { return this; }
    return negate(); }

  //--------------------------------------------------------------

  private final BigFloatN multiply (final boolean nonNegative,
                                    final Natural t,
                                    final int e) {
    return valueOf(
  ...
  public final BigFloatN multiply (final BigFloatN q) {
  ...
  public final BigFloatN multiply (final double z) {
    return 
      multiply(
        Doubles.nonNegative(z),
  ...
  public final BigFloatN add2 (final double z) { 
    //assert Double.isFinite(z);
    final BigFloatN q = valueOf(z);
    return add(q.multiply(q)); }

  //--------------------------------------------------------------
  // TODO: optimize!

  public final BigFloatN addProduct (final double z0,
                                     final double z1) { 
  ...
  @Override
  public final int compareTo (final BigFloatN q) {
  ...
  public final boolean equals (final BigFloatN q) {
  ...
  public boolean equals (final Object o) {
    if (!(o instanceof BigFloatN)) { return false; }
    return equals((BigFloatN) o); }
  ...
  private BigFloatN (final boolean nonNegative,
                     final Natural t0,
                     final int e0) {
    //super();
    if (isZero(t0)) {
      _nonNegative = true;
      _significand = Natural.ZERO;
      _exponent = 0; }
    else {
  ...
  public static final BigFloatN valueOf (final boolean nonNegative,
                                         final Natural t,
                                         final int e) {
    if (isZero(t)) { return ZERO; }
    //assert 0 < t.signum();
    return new BigFloatN(nonNegative,t,e); } 

  public static final BigFloatN valueOf (final long t,
                                         final int e) {
    if (0L < t) {
      return valueOf(true,Natural.valueOf(t),e); }
    return valueOf(false,Natural.valueOf(-t),e); }

  public static final BigFloatN valueOf (final int t,
                                         final int e) {
    if (0 < t) {
      return valueOf(true,Natural.valueOf(t),e); }
    return valueOf(false,Natural.valueOf(-t),e); }
  ...
  private static final BigFloatN valueOf (final boolean nonNegative,
                                          final int e0,
                                          final long t0)  {
    if (0L == t0) { return ZERO; }
    return valueOf(nonNegative,Natural.valueOf(t0),e0); } 

  public static final BigFloatN valueOf (final double x)  {
    return valueOf(
  ...
  public static final BigFloatN valueOf (final float x)  {
    return valueOf(
  ...
  public static final BigFloatN valueOf (final byte t)  {
    if (0 < t) {
      return valueOf(true,Natural.valueOf(t),0); }
    return valueOf(false,Natural.valueOf(-t),0); }

  public static final BigFloatN valueOf (final short t)  {
    if (0 < t) {
      return valueOf(true,Natural.valueOf(t),0); }
    return valueOf(false,Natural.valueOf(-t),0); }
  ...
  public static final BigFloatN valueOf (final Byte x)  {
    return valueOf(x.byteValue()); }

  public static final BigFloatN valueOf (final Short x)  {
    return valueOf(x.shortValue()); }

  public static final BigFloatN valueOf (final Integer x)  {
    return valueOf(x.intValue()); }

  public static final BigFloatN valueOf (final Long x)  {
    return valueOf(x.longValue()); }

  public static final BigFloatN valueOf (final BigDecimal x)  {
    throw Exceptions.unsupportedOperation(null,"valueOf",x); }
  //    return valueOf(x, Natural.ONE); }

  public static final BigFloatN valueOf (final Natural x)  {
    return valueOf(true,x,0); }

  public static final BigFloatN valueOf (final Number x)  {
    if (x instanceof BigFloatN) { return (BigFloatN) x; }
  ...
  public static final BigFloatN valueOf (final Object x)  {
    return valueOf((Number) x); }

  //--------------------------------------------------------------

  public static final BigFloatN ZERO = 
    new BigFloatN(true,Natural.ZERO,0);

  public static final BigFloatN ONE = 
    new BigFloatN(true,Natural.ONE,0);

  public static final BigFloatN TWO = 
    new BigFloatN(true,Natural.ONE,1);

  public static final BigFloatN TEN = 
    new BigFloatN(true,Natural.valueOf(5),1);

  public static final BigFloatN MINUS_ONE =
    new BigFloatN(false,Natural.ONE,0);
