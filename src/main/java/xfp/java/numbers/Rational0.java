...
public final class Rational0 
extends Number
implements Comparable<Rational0> {
  ...
  public final Rational0 add (final double q) {
  ...
  public static final double doubleValue6 (final boolean negative,
    ...
    if (subnormal) {
      ...
      //      assert hiBit(q) <= NUMERATOR_BITS 
      //        : "too many bits:" + description("q",q);
      assert q6.compareTo(Rational0.TWO_52) <= 0; }
    else {
  ...
  private static final Rational0 reduced (final BigInteger n,
    ...
    if (n == BigInteger.ZERO) { 
      return new Rational0(n,BigInteger.ONE); }
  ...
  public static final Rational0 ZERO = 
    Rational0.valueOf(BigInteger.ZERO,BigInteger.ONE);

  public static final Rational0 ONE = 
    Rational0.valueOf(BigInteger.ONE,BigInteger.ONE);

  public static final Rational0 TWO = 
    Rational0.valueOf(BigInteger.TWO,BigInteger.ONE);

  public static final Rational0 TEN = 
    Rational0.valueOf(BigInteger.TEN,BigInteger.ONE);

  public static final Rational0 MINUS_ONE = 
    Rational0.valueOf(BigInteger.ONE.negate(),BigInteger.ONE);
