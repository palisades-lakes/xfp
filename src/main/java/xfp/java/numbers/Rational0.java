...
public final class Rational0 extends Number
implements Ringlike<Rational0> {
  ...
  private static final Rational0 reduced (final BigInteger n,
                                          final BigInteger d) {
    assert 0 != d.signum();
    ...
    if ((n == BigInteger.ONE) || (d == BigInteger.ONE)) {
      return new Rational0(n,d); }

    final BigInteger gcd = n.gcd(d);
    if (gcd.compareTo(BigInteger.ONE) > 0) {
      return new Rational0(n.divide(gcd),d.divide(gcd)); }
  ...
  @Override
  public final Rational0 negate () {
    if (isZero()) { return this; }
    return valueOf(numerator().negate(),denominator()); }

  public final Rational0 reciprocal () {
    assert !isZero(numerator());
    return valueOf(denominator(),numerator()); }

  //--------------------------------------------------------------

  private final Rational0 add (final BigInteger n,
                               final BigInteger d) {
    return valueOf(
  ...
  @Override
  public final Rational0 add (final Rational0 q) {
    if (isZero()) { return q; }
    if (q.isZero()) { return this; }
    return add(q.numerator(),q.denominator()); }

  public final Rational0 add (final double z) {
  ...
  @Override
  public final Rational0 subtract (final Rational0 q) {
    if (isZero()) { return q.negate(); }
    if (q.isZero()) { return this; }
    return add(q.numerator().negate(),q.denominator()); }

  @Override
  public final Rational0 abs () {
    // TODO: direct signum
  ...
  private final Rational0 multiply (final BigInteger n,
                                    final BigInteger d) {
    return
      valueOf(
  ...
  @Override
  public final Rational0 multiply (final Rational0 q) {
  ...
  public final Rational0 add2 (final double z) {
    assert Double.isFinite(z);
    final boolean s = Doubles.nonNegative(z);
  ...
  public final Rational0 addProduct (final double z0,
                                     final double z1) {
  ...
  @Override
  public final int compareTo (final Rational0 o) {
  ...
  public final boolean equals (final Rational0 q) {
  ...
  public boolean equals (final Object o) {
    if (!(o instanceof Rational0)) { return false; }
    return equals((Rational0) o); }
  ...
  private Rational0 (final BigInteger numerator,
  ...
  public static final Rational0 valueOf (final BigInteger n,
                                         final BigInteger d) {
    assert 0 != d.signum();
    if (isNegative(d)) {
  ...
  public static final Rational0 valueOf (final long n,
                                         final long d) {
    assert 0L != d;
  ...
  public static final Rational0 valueOf (final int n,
                                         final int d) {
    assert 0 != d;
  ...
  private static final Rational0 valueOf (final boolean nonNegative,
                                          final int e,
                                          final long t)  {
    if (0L == t) { return ZERO; }
  ...
  public static final Rational0 valueOf (final double x)  {
    return valueOf(
  ...
  public static final Rational0 valueOf (final float x)  {
    return valueOf(
  ...
  public static final Rational0 valueOf (final byte x)  {
    return valueOf(BigInteger.valueOf(x), BigInteger.ONE); }

  public static final Rational0 valueOf (final short x)  {
    return valueOf(BigInteger.valueOf(x), BigInteger.ONE); }

  public static final Rational0 valueOf (final int x)  {
    return valueOf(BigInteger.valueOf(x), BigInteger.ONE); }

  public static final Rational0 valueOf (final long x)  {
    return valueOf(BigInteger.valueOf(x), BigInteger.ONE); }
  ...
  public static final Rational0 valueOf (final Integer x)  {
    return valueOf(x.intValue()); }

  public static final Rational0 valueOf (final Long x)  {
    return valueOf(x.longValue()); }

  public static final Rational0 valueOf (final BigDecimal x)  {
    throw Exceptions.unsupportedOperation(null,"valueOf",x); }
  //    return valueOf(x, BigInteger.ONE); }

  public static final Rational0 valueOf (final BigInteger x)  {
    return valueOf(x, BigInteger.ONE); }

  public static final Rational0 valueOf (final Number x)  {
    if (x instanceof Rational0) { return (Rational0) x; }
  ...
  public static final Rational0 valueOf (final Object x)  {
    return valueOf((Number) x); }

  //--------------------------------------------------------------

  public static final Rational0 ZERO =
    new Rational0(BigInteger.ZERO,BigInteger.ONE);

  public static final Rational0 ONE =
    new Rational0(BigInteger.ONE,BigInteger.ONE);

  public static final Rational0 TWO =
    new Rational0(BigInteger.TWO,BigInteger.ONE);

  public static final Rational0 TEN =
    new Rational0(BigInteger.TEN,BigInteger.ONE);

  public static final Rational0 MINUS_ONE = ONE.negate();
