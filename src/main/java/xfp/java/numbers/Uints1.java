...
public interface Uints1<T extends Uints1> 
...
//    final int lo = loInt();
//    if (0>=lo) {
//      for (int i=lo;i<hiInt(); i++) {
//        hashCode = (int) ((31 * hashCode) + uword(i)); } }
    return hashCode; }

  // DANGER: equality across classes
  default boolean uintsEquals (final Uints1 x) {
    if (x==this) { return true; }
    final Uints1 u = x;
    final int start = Math.max(startWord(),u.startWord());
