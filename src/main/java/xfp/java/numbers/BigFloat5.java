...
public final class BigFloat5 implements Ringlike<BigFloat5> {
  ...
  private static final BigFloat5 add (final boolean p0,
                                     final Natural t0,
                                     final int e0,
                                     final boolean p1,
                                     final Natural t1,
  ...
  private static final BigFloat5
...
//    return valueOf(p0,t0.add(upShift,t1),e); }
  ...
  add (final boolean p0,
    ...
    if (e0<e1) { return add5b(p0,t0,p1,NaturalLE.valueOf(t1,e1-e0),e0); }
  ...
  public BigFloat5 addL1 (final double z0,
                         final double z1) {
  ...
  addL2 (final double z0,
    ...
    //assert Double.isFinite(z0);
    //assert Double.isFinite(z1);
    final BigFloat5 dz = difference(z0,z1);
  ...
  private static final boolean reducedEquals (final BigFloat5 a,
                                              final BigFloat5 b) {
  ...
  private BigFloat5 (final boolean p0,
                    final Natural t0,
                    final int e0) {
    _nonNegative = p0;
    _significand = t0;
  ...
  public static final BigFloat5 ZERO =
    new BigFloat5(true,NaturalLE.ZERO,0);
...
//    return new BigFloat(p0, t0.shiftDown(shift),e0+shift); }
  ...
  private final BigFloat5 reduce () {
    final boolean p0 = nonNegative();
    final Natural t0 = significand();
    final int e0 = exponent();
    final int shift = t0.loBit();
    if (0>=shift) { return this; }
    return new BigFloat5(p0, t0.shiftDown(shift),e0+shift); }

  public static final BigFloat5 valueOf (final boolean p0,
                                        final Natural t0,
                                        final int e0) {
    //return reduce(p0,t0,e0); }
    return new BigFloat5(p0, t0,e0); }
  ...
  public static final BigFloat5 valueOf (final double z)  {
    return valueOf(
      Doubles.nonNegative(z),
      Doubles.significand(z),
      Doubles.exponent(z)); }
