...
public final class MutableUnNatural {
   ...
   */
  private int[] value;
  private final void setValue (final int[] val, final int length) {
   ...
   *
   */
  private final int divideOneWord(final int divisor, final MutableUnNatural quotient) {
   ...
   * @return {@code this%b}
   */
  private final MutableUnNatural divide2n1n (final MutableUnNatural b, 
                                             final MutableUnNatural quotient) {
   ...
   * @return {@code this%b}
   */
  private final MutableUnNatural divide3n2n (final MutableUnNatural b,
                                             final MutableUnNatural quotient) {
