...
logic~\cite{wiki:Propositional_calculus,wiki:Zeroth_order_logic}
...
and logical connectives defining well-formed formulas,
...
First-order logic~\cite{wiki:First_order_logic}
