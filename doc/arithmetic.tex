...
\item[\textbf{ZFC}] \textbf{ZF} with axiom of choice\cite{wiki:Axiom_of_choice}.
\item[\textbf{ZFA}] \textbf{ZF} with ur-elements\cite{wiki:Urelement}
\item[\textbf{ZFAC}] \textbf{ZFA} with axiom of choice\cite{wiki:Axiom_of_choice}.
\end{description}
